...
if isHD():
	SKIN_IPAudioSetup_ICONE ="""<screen name="IPAudioSetup" position="center,center" size="850,400" title="IPAudio Setup" flags="wfNoBorder">
					<ePixmap position="0,0" zPosition="-1" size="850,400" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/setup_screen.png" alphatest="blend" />
					<ePixmap position="10,335" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/red.png" alphatest="blend" />
					...
					<ePixmap position="760,335" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/green.png" alphatest="blend" />
	...
	if os.path.exists('/var/lib/dpkg/status'):	
		SKIN_IPAudioSetup_ICONE = """<screen name="IPAudioSetup" position="center,center" size="1154,584" title="IPAudio Setup" flags="wfNoBorder">
						<ePixmap position="0,0" zPosition="-1" size="1154,584" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/setup_screen.png" alphatest="blend" />
						<ePixmap position="10,500" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/red.png" alphatest="blend" />
						...
						<ePixmap position="1060,500" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/green.png" alphatest="blend" />
...
if isHD():
	SKIN_IPAudioSetup_Light = """<screen name="IPAudioSetup" position="center,center" size="850,400" title="IPAudio Setup" flags="wfNoBorder">
					...
					<ePixmap position="10,350" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/red.png" alphatest="blend" />
					...
					<ePixmap position="760,350" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/green.png" alphatest="blend" />
	...
	if os.path.exists('/var/lib/dpkg/status'):	
		SKIN_IPAudioSetup_Light = """<screen name="IPAudioSetup" position="center,center" size="1154,584" title="IPAudio Setup" flags="wfNoBorder">
						<ePixmap position="0,0" zPosition="-1" size="1154,584" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/setup_screen.png" alphatest="blend" />
						<ePixmap position="10,500" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/red.png" alphatest="blend" />
						<widget source="red_key" render="Label" position="58,510" zPosition="2" size="165,30" font="Regular; 26" halign="center" valign="center" transparent="1" />
						<ePixmap position="1060,500" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/green.png" alphatest="blend" />
						<widget source="green_key" render="Label" position="940,510" zPosition="2" size="165,30" font="Regular; 26" halign="center" valign="center" transparent="1" />
					<widget position="8,107" size="1138,350" name="config" foregroundColor="#00ffffff" backgroundColor="#16000000" itemHeight="68" selectionPixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/list_setup_pixmap.png" scrollbarMode="showNever" />
		...
		SKIN_IPAudioSetup_Light = """<screen name="IPAudioSetup" position="center,center" size="1154,584" title="IPAudio Setup" flags="wfNoBorder">
						...
						<ePixmap position="1060,500" zPosition="1" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/green.png" alphatest="blend" />
						<widget source="green_key" render="Label" position="940,510" zPosition="2" size="165,30" font="Regular; 26" halign="center" valign="center" transparent="1" />
					<widget position="8,107" size="1138,350" name="config" foregroundColor="#00ffffff" backgroundColor="#16000000" itemHeight="68" selectionPixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/list_setup_pixmap.png" font="Regular; 32" scrollbarMode="showNever" />
					<widget source="Title" position="455,32" size="251,45" render="Label" font="Regular;35" foregroundColor="#00000000" backgroundColor="#77ffffff" transparent="1" />
				</screen>"""

#### SKIN IPAudioScreen ICOON
if isHD():
	SKIN_IPAudioScreen_ICONE="""<screen name="IPAudio" position="center,center" size="1280,720" title="IPAudio By ZIKO V {}" backgroundColor="#ffffffff" flags="wfNoBorder">
					<ePixmap position="0,0" zPosition="-1" size="1280,720" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/bg_screen_hd.png" alphatest="blend" />
					<ePixmap position="54,151" zPosition="2" size="447,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/list_1pixmap.png" alphatest="blend" />
					<ePixmap position="458,170" zPosition="2" size="39,15" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/HD/left_right_zap.png" alphatest="blend" />
	...
	SKIN_IPAudioScreen_ICONE="""<screen name="IPAudio" position="center,center" size="1920,1080" title="IPAudio By ZIKO V {}" backgroundColor="#ffffffff" flags="wfNoBorder">
					<ePixmap position="0,0" zPosition="-1" size="1920,1080" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/bg_screen_fullhd.png" alphatest="blend" />
					<ePixmap position="85,247" zPosition="2" size="666,58" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/list_1pixmap.png" alphatest="blend" />
					<ePixmap position="695,270" zPosition="2" size="52,21" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/left_right_zap.png" alphatest="blend" />
					<widget source="Title" position="274,115" size="425,40" render="Label" font="Regular;30" foregroundColor="#3b3b3d" backgroundColor="#16000000" transparent="1" />
					<widget font="Regular;35" foregroundColor="#3b3b3d" backgroundColor="#16000000" halign="center" position="1015,108" render="Label" size="143,52" source="global.CurrentTime" transparent="1" valign="center" zPosition="5">
	  					<convert type="ClockToText">Default</convert>
					</widget>
					<widget name="server" font="Regular;32" foregroundColor="white" backgroundColor="#16000000" position="300,255" size="300,55" transparent="1" zPosition="5" />
...
if isHD():
	SKIN_IPAudioScreen_Light="""<screen name="IPAudio" position="center,center" size="1280,720" title="IPAudio By ZIKO V {}" backgroundColor="#ffffffff" flags="wfNoBorder">
	...
	SKIN_IPAudioScreen_Light="""<screen name="IPAudio" position="center,center" size="1920,1080" title="IPAudio By ZIKO V {}" backgroundColor="#ffffffff" flags="wfNoBorder">
				...
				<ePixmap position="695,270" zPosition="2" size="52,21" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/left_right_zap.png" alphatest="blend" />
					...
					<widget name="server" font="Regular;32" foregroundColor="#00ffffff" backgroundColor="#16000000" position="300,255" size="300,55" transparent="1" zPosition="5" />
					<ePixmap name="green" position="86,375" zPosition="2" size="80,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPAudio/icons/FHD/green.png" transparent="1" alphatest="blend" />
